...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile11_bd2), /* addrA */ 0x81000,  /* len */ 4096));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile11_bd3), /* addrA */ 0x91000,  /* len */ 4096));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile11_bd4), /* addrA */ 0x82000,  /* len */ 4096));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile11_bd5), /* addrA */ 0x92000,  /* len */ 4096));
...
const int hh_cons_buff_0_offset = 0;
...
const int kk_cons_buff_0_offset = 0;
