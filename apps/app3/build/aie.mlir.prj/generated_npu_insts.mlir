module {
  aie.device(npu1_1col) {
    ...
    ^bb4:  // pred: ^bb3
      ...
      aie.use_lock(%out_prod_lock, AcquireGreaterEqual, 1)
      aie.use_lock(%in_cons_cons_lock, AcquireGreaterEqual, 1)
      func.call @mean(%in_cons_buff_1, %out_buff_1, %c1024_i32) : (memref<1024xi32>, memref<1xi32>, i32) -> ()
      aie.use_lock(%in_cons_prod_lock, Release, 1)
      aie.use_lock(%out_cons_lock, Release, 1)
    ...
    memref.global "private" constant @blockwrite_data_2 : memref<8xi32> = dense<[4, 0, 0, 0, -2147483648, 0, 0, 33554432]>
