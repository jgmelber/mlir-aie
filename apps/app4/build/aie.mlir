module {
  aie.device(npu1_4col) {
    ...
    aie.objectfifo @in0(%tile_0_0, {%tile_0_2}, 2 : i32) : !aie.objectfifo<memref<1024xi32>>
    aie.objectfifo @infactor(%tile_0_0, {%tile_0_2}, 2 : i32) : !aie.objectfifo<memref<1xi32>>
    aie.objectfifo @in1(%tile_1_0, {%tile_1_2}, 2 : i32) : !aie.objectfifo<memref<1024xi32>>
    ...
    %core_0_2 = aie.core(%tile_0_2) {
      ...
      scf.for %arg0 = %c0 to %c9223372036854775807 step %c1 {
        ...
        scf.for %arg1 = %c0_0 to %c9 step %c1_1 {
          ...
          %4 = aie.objectfifo.acquire @in0(Consume, 1) : !aie.objectfifosubview<memref<1024xi32>>
