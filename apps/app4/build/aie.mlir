module {
  aie.device(npu1_4col) {
    ...
    aie.objectfifo @in0(%tile_0_0, {%tile_0_2}, 2 : i32) : !aie.objectfifo<memref<1xf32>>
    aie.objectfifo @in1(%tile_0_0, {%tile_0_2}, 2 : i32) : !aie.objectfifo<memref<1024xf32>>
    ...
    aie.objectfifo @in0to1(%tile_0_2, {%tile_0_3}, 2 : i32) : !aie.objectfifo<memref<1024xf32>>
    aie.objectfifo @in1to2(%tile_0_3, {%tile_0_4}, 2 : i32) : !aie.objectfifo<memref<1024xf32>>
    aie.objectfifo @in2to3(%tile_0_4, {%tile_3_5}, 2 : i32) : !aie.objectfifo<memref<1024xf32>>
    aie.objectfifo @out(%tile_3_5, {%tile_3_0}, 2 : i32) : !aie.objectfifo<memref<1024xf32>>
    %core_0_2 = aie.core(%tile_0_2) {
      ...
      scf.for %arg0 = %c0 to %c9223372036854775807 step %c1 {
        ...
        scf.for %arg1 = %c0_0 to %c10 step %c1_1 {
          %2 = aie.objectfifo.acquire @in0to1(Produce, 1) : !aie.objectfifosubview<memref<1024xf32>>
          %3 = aie.objectfifo.subview.access %2[0] : !aie.objectfifosubview<memref<1024xf32>> -> memref<1024xf32>
          %4 = aie.objectfifo.acquire @in1(Consume, 1) : !aie.objectfifosubview<memref<1024xf32>>
    ...
    %core_0_3 = aie.core(%tile_0_3) {
      ...
      scf.for %arg0 = %c0 to %c9223372036854775807 step %c1 {
        ...
        %c1_1 = arith.constant 1 : index
        scf.for %arg1 = %c0_0 to %c10 step %c1_1 {
          %0 = aie.objectfifo.acquire @in1to2(Produce, 1) : !aie.objectfifosubview<memref<1024xf32>>
          %1 = aie.objectfifo.subview.access %0[0] : !aie.objectfifosubview<memref<1024xf32>> -> memref<1024xf32>
          %2 = aie.objectfifo.acquire @in0to1(Consume, 1) : !aie.objectfifosubview<memref<1024xf32>>
          %3 = aie.objectfifo.subview.access %2[0] : !aie.objectfifosubview<memref<1024xf32>> -> memref<1024xf32>
          %c1024_i32 = arith.constant 1024 : i32
    ...
    %core_0_4 = aie.core(%tile_0_4) {
      ...
      scf.for %arg0 = %c0 to %c9223372036854775807 step %c1 {
        ...
        %c1_1 = arith.constant 1 : index
        scf.for %arg1 = %c0_0 to %c10 step %c1_1 {
          %0 = aie.objectfifo.acquire @in2to3(Produce, 1) : !aie.objectfifosubview<memref<1024xf32>>
          %1 = aie.objectfifo.subview.access %0[0] : !aie.objectfifosubview<memref<1024xf32>> -> memref<1024xf32>
          %2 = aie.objectfifo.acquire @in1to2(Consume, 1) : !aie.objectfifosubview<memref<1024xf32>>
          %3 = aie.objectfifo.subview.access %2[0] : !aie.objectfifosubview<memref<1024xf32>> -> memref<1024xf32>
          %c0_2 = arith.constant 0 : index
          %c1024 = arith.constant 1024 : index
          %c1_3 = arith.constant 1 : index
          scf.for %arg2 = %c0_2 to %c1024 step %c1_3 {
            %4 = memref.load %3[%arg2] : memref<1024xf32>
            memref.store %4, %1[%arg2] : memref<1024xf32>
          }
    ...
    %core_3_5 = aie.core(%tile_3_5) {
      ...
      scf.for %arg0 = %c0 to %c9223372036854775807 step %c1 {
        ...
        %c1_1 = arith.constant 1 : index
        scf.for %arg1 = %c0_0 to %c10 step %c1_1 {
          %0 = aie.objectfifo.acquire @out(Produce, 1) : !aie.objectfifosubview<memref<1024xf32>>
          %1 = aie.objectfifo.subview.access %0[0] : !aie.objectfifosubview<memref<1024xf32>> -> memref<1024xf32>
          %2 = aie.objectfifo.acquire @in2to3(Consume, 1) : !aie.objectfifosubview<memref<1024xf32>>
          %3 = aie.objectfifo.subview.access %2[0] : !aie.objectfifosubview<memref<1024xf32>> -> memref<1024xf32>
          %c0_2 = arith.constant 0 : index
          %c1024 = arith.constant 1024 : index
          %c1_3 = arith.constant 1 : index
