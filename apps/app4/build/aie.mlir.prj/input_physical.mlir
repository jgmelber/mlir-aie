module {
  aie.device(npu1_4col) {
    ...
    ^bb4:  // pred: ^bb3
      ...
      func.call @vector_scalar_mul_aie_scalar(%in1_cons_buff_1, %in0to1_buff_1, %in0_cons_buff_0, %c1024_i32_3) : (memref<1024xi32>, memref<1024xi32>, memref<1xi32>, i32) -> ()
      aie.use_lock(%in1_cons_prod_lock, Release, 1)
      aie.use_lock(%in0to1_cons_lock, Release, 1)
    ...
    ^bb5:  // pred: ^bb3
      ...
      func.call @vector_scalar_mul_aie_scalar(%in1_cons_buff_0, %in0to1_buff_0, %in0_cons_buff_0, %c1024_i32_4) : (memref<1024xi32>, memref<1024xi32>, memref<1xi32>, i32) -> ()
      aie.use_lock(%in1_cons_prod_lock, Release, 1)
      aie.use_lock(%in0to1_cons_lock, Release, 1)
    ...
    ^bb7:  // pred: ^bb6
      ...
      func.call @vector_scalar_mul_aie_scalar(%in1_cons_buff_1, %in0to1_buff_1, %in0_cons_buff_1, %c1024_i32_10) : (memref<1024xi32>, memref<1024xi32>, memref<1xi32>, i32) -> ()
      aie.use_lock(%in1_cons_prod_lock, Release, 1)
      aie.use_lock(%in0to1_cons_lock, Release, 1)
      aie.use_lock(%in0to1_prod_lock, AcquireGreaterEqual, 1)
      aie.use_lock(%in1_cons_cons_lock, AcquireGreaterEqual, 1)
      %c1024_i32_11 = arith.constant 1024 : i32
      func.call @vector_scalar_mul_aie_scalar(%in1_cons_buff_0, %in0to1_buff_0, %in0_cons_buff_1, %c1024_i32_11) : (memref<1024xi32>, memref<1024xi32>, memref<1xi32>, i32) -> ()
      aie.use_lock(%in1_cons_prod_lock, Release, 1)
      aie.use_lock(%in0to1_cons_lock, Release, 1)
    ...
    ^bb8:  // pred: ^bb6
      ...
      func.call @vector_scalar_mul_aie_scalar(%in1_cons_buff_1, %in0to1_buff_1, %in0_cons_buff_1, %c1024_i32_12) : (memref<1024xi32>, memref<1024xi32>, memref<1xi32>, i32) -> ()
      aie.use_lock(%in1_cons_prod_lock, Release, 1)
      aie.use_lock(%in0to1_cons_lock, Release, 1)
      aie.use_lock(%in0_cons_prod_lock, Release, 1)
    ...
    ^bb11:  // pred: ^bb10
      ...
      func.call @vector_scalar_mul_aie_scalar(%in1_cons_buff_0, %in0to1_buff_0, %in0_cons_buff_0, %c1024_i32_18) : (memref<1024xi32>, memref<1024xi32>, memref<1xi32>, i32) -> ()
      aie.use_lock(%in1_cons_prod_lock, Release, 1)
      aie.use_lock(%in0to1_cons_lock, Release, 1)
      aie.use_lock(%in0to1_prod_lock, AcquireGreaterEqual, 1)
      aie.use_lock(%in1_cons_cons_lock, AcquireGreaterEqual, 1)
      %c1024_i32_19 = arith.constant 1024 : i32
      func.call @vector_scalar_mul_aie_scalar(%in1_cons_buff_1, %in0to1_buff_1, %in0_cons_buff_0, %c1024_i32_19) : (memref<1024xi32>, memref<1024xi32>, memref<1xi32>, i32) -> ()
      aie.use_lock(%in1_cons_prod_lock, Release, 1)
      aie.use_lock(%in0to1_cons_lock, Release, 1)
    ...
    ^bb12:  // pred: ^bb10
      ...
      func.call @vector_scalar_mul_aie_scalar(%in1_cons_buff_0, %in0to1_buff_0, %in0_cons_buff_0, %c1024_i32_20) : (memref<1024xi32>, memref<1024xi32>, memref<1xi32>, i32) -> ()
      aie.use_lock(%in1_cons_prod_lock, Release, 1)
      aie.use_lock(%in0to1_cons_lock, Release, 1)
      aie.use_lock(%in0_cons_prod_lock, Release, 1)
      aie.end
