module {
  aie.device(npu1_4col) {
    ...
    %out_buff_0 = aie.buffer(%tile_3_5) {address = 0 : i32, mem_bank = 0 : i32, sym_name = "out_buff_0"} : memref<1024xi32> 
    %out_buff_1 = aie.buffer(%tile_3_5) {address = 4096 : i32, mem_bank = 0 : i32, sym_name = "out_buff_1"} : memref<1024xi32> 
    ...
    %in2to3_cons_buff_0 = aie.buffer(%tile_3_5) {address = 8192 : i32, mem_bank = 0 : i32, sym_name = "in2to3_cons_buff_0"} : memref<1024xi32> 
    %in2to3_cons_buff_1 = aie.buffer(%tile_3_5) {address = 12288 : i32, mem_bank = 0 : i32, sym_name = "in2to3_cons_buff_1"} : memref<1024xi32> 
    ...
    ^bb7:  // pred: ^bb6
      ...
      func.call @vector_scalar_mul_aie_scalar(%in1_cons_buff_0, %in0to1_buff_0, %in0_cons_buff_1, %c1024_i32_8) : (memref<1024xi32>, memref<1024xi32>, memref<1xi32>, i32) -> ()
      aie.use_lock(%in1_cons_prod_lock, Release, 1)
      aie.use_lock(%in0to1_cons_lock, Release, 1)
      aie.use_lock(%in0to1_prod_lock, AcquireGreaterEqual, 1)
      aie.use_lock(%in1_cons_cons_lock, AcquireGreaterEqual, 1)
      %c1024_i32_9 = arith.constant 1024 : i32
      func.call @vector_scalar_mul_aie_scalar(%in1_cons_buff_1, %in0to1_buff_1, %in0_cons_buff_1, %c1024_i32_9) : (memref<1024xi32>, memref<1024xi32>, memref<1xi32>, i32) -> ()
      aie.use_lock(%in1_cons_prod_lock, Release, 1)
      aie.use_lock(%in0to1_cons_lock, Release, 1)
    ...
    ^bb11:  // pred: ^bb10
      ...
      func.call @vector_scalar_mul_aie_scalar(%in1_cons_buff_0, %in0to1_buff_0, %in0_cons_buff_0, %c1024_i32_14) : (memref<1024xi32>, memref<1024xi32>, memref<1xi32>, i32) -> ()
      aie.use_lock(%in1_cons_prod_lock, Release, 1)
      aie.use_lock(%in0to1_cons_lock, Release, 1)
      aie.use_lock(%in0to1_prod_lock, AcquireGreaterEqual, 1)
      aie.use_lock(%in1_cons_cons_lock, AcquireGreaterEqual, 1)
      %c1024_i32_15 = arith.constant 1024 : i32
      func.call @vector_scalar_mul_aie_scalar(%in1_cons_buff_1, %in0to1_buff_1, %in0_cons_buff_0, %c1024_i32_15) : (memref<1024xi32>, memref<1024xi32>, memref<1xi32>, i32) -> ()
      aie.use_lock(%in1_cons_prod_lock, Release, 1)
      aie.use_lock(%in0to1_cons_lock, Release, 1)
