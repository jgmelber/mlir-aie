...
13:                                               ; preds = %0, %13
  ...
  tail call void @vector_scalar_mul_aie_scalar(ptr nonnull @in1_cons_buff_0, ptr nonnull @out_buff_0, ptr nonnull @in0_cons_buff_0, i32 1024)
  ...
  tail call void @vector_scalar_mul_aie_scalar(ptr nonnull @in1_cons_buff_1, ptr nonnull @out_buff_1, ptr nonnull @in0_cons_buff_0, i32 1024)
  tail call void @llvm.aie2.release(i32 50, i32 1)
  tail call void @llvm.aie2.release(i32 53, i32 1)
  tail call void @llvm.aie2.acquire(i32 52, i32 -1)
  tail call void @llvm.aie2.acquire(i32 51, i32 -1)
  ...
  tail call void @vector_scalar_mul_aie_scalar(ptr nonnull @in1_cons_buff_0, ptr nonnull @out_buff_0, ptr nonnull @in0_cons_buff_1, i32 1024)
  tail call void @llvm.aie2.release(i32 50, i32 1)
  tail call void @llvm.aie2.release(i32 53, i32 1)
  tail call void @llvm.aie2.acquire(i32 52, i32 -1)
  tail call void @llvm.aie2.acquire(i32 51, i32 -1)
  tail call void @vector_scalar_mul_aie_scalar(ptr nonnull @in1_cons_buff_1, ptr nonnull @out_buff_1, ptr nonnull @in0_cons_buff_1, i32 1024)
  tail call void @llvm.aie2.release(i32 50, i32 1)
  tail call void @llvm.aie2.release(i32 53, i32 1)
  tail call void @llvm.aie2.acquire(i32 52, i32 -1)
  tail call void @llvm.aie2.acquire(i32 51, i32 -1)
