module attributes {llvm.target_triple = "aie2"} {
  ...
  llvm.mlir.global external @in0to1_buff_1() {addr_space = 0 : i32} : !llvm.array<1024 x f32>
  llvm.mlir.global external @in0to1_buff_0() {addr_space = 0 : i32} : !llvm.array<1024 x f32>
  llvm.mlir.global external @in1to2_buff_1() {addr_space = 0 : i32} : !llvm.array<1024 x f32>
  llvm.mlir.global external @in1to2_buff_0() {addr_space = 0 : i32} : !llvm.array<1024 x f32>
  llvm.mlir.global external @in2to3_buff_1() {addr_space = 0 : i32} : !llvm.array<1024 x f32>
  llvm.mlir.global external @in2to3_buff_0() {addr_space = 0 : i32} : !llvm.array<1024 x f32>
  llvm.mlir.global external @in2to3_cons_buff_1() {addr_space = 0 : i32} : !llvm.array<1024 x f32>
  llvm.mlir.global external @in2to3_cons_buff_0() {addr_space = 0 : i32} : !llvm.array<1024 x f32>
  ...
  llvm.mlir.global external @in2to3_cons() {addr_space = 0 : i32} : !llvm.array<1024 x f32>
  llvm.mlir.global external @in2to3() {addr_space = 0 : i32} : !llvm.array<1024 x f32>
  llvm.mlir.global external @in1to2() {addr_space = 0 : i32} : !llvm.array<1024 x f32>
  llvm.mlir.global external @in0to1() {addr_space = 0 : i32} : !llvm.array<1024 x f32>
  ...
  llvm.func @core_3_5() {
    ...
    llvm.br ^bb1(%14 : i64)
  ^bb1(%17: i64):  // 2 preds: ^bb0, ^bb10
    %18 = llvm.icmp "slt" %17, %15 : i64
    llvm.cond_br %18, ^bb2(%14 : i64), ^bb11
  ...
  ^bb5:  // pred: ^bb4
    %23 = llvm.getelementptr %4[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.array<1024 x f32>
    %24 = llvm.ptrtoint %23 : !llvm.ptr to i64
    %25 = llvm.and %24, %3  : i64
    %26 = llvm.icmp "eq" %25, %14 : i64
    llvm.intr.assume %26 : i1
    %27 = llvm.getelementptr %23[%21] : (!llvm.ptr, i64) -> !llvm.ptr, f32
    ...
    %33 = llvm.getelementptr %29[%21] : (!llvm.ptr, i64) -> !llvm.ptr, f32
    llvm.store %28, %33 : f32, !llvm.ptr
    %34 = llvm.add %21, %16 : i64
    llvm.br ^bb4(%34 : i64)
  ^bb6:  // pred: ^bb4
  ...
  ^bb8:  // pred: ^bb7
    ...
    %41 = llvm.getelementptr %37[%35] : (!llvm.ptr, i64) -> !llvm.ptr, f32
    ...
    %46 = llvm.icmp "eq" %45, %14 : i64
    llvm.intr.assume %46 : i1
    %47 = llvm.getelementptr %43[%35] : (!llvm.ptr, i64) -> !llvm.ptr, f32
    llvm.store %42, %47 : f32, !llvm.ptr
    %48 = llvm.add %35, %16 : i64
    llvm.br ^bb7(%48 : i64)
  ^bb9:  // pred: ^bb7
    llvm.call @llvm.aie2.release(%6, %9) : (i32, i32) -> ()
    llvm.call @llvm.aie2.release(%5, %9) : (i32, i32) -> ()
    %49 = llvm.add %19, %12 : i64
    llvm.br ^bb2(%49 : i64)
  ^bb10:  // pred: ^bb2
    %50 = llvm.add %17, %16 : i64
    llvm.br ^bb1(%50 : i64)
  ^bb11:  // pred: ^bb1
    llvm.return
  }
  ...
  ^bb5:  // pred: ^bb4
    %22 = llvm.getelementptr %4[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.array<1024 x f32>
    %23 = llvm.ptrtoint %22 : !llvm.ptr to i64
    %24 = llvm.and %23, %3  : i64
    %25 = llvm.icmp "eq" %24, %13 : i64
    llvm.intr.assume %25 : i1
    %26 = llvm.getelementptr %22[%20] : (!llvm.ptr, i64) -> !llvm.ptr, f32
    ...
    %32 = llvm.getelementptr %28[%20] : (!llvm.ptr, i64) -> !llvm.ptr, f32
  ...
  ^bb8:  // pred: ^bb7
    %36 = llvm.getelementptr %1[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.array<1024 x f32>
    %37 = llvm.ptrtoint %36 : !llvm.ptr to i64
    %38 = llvm.and %37, %3  : i64
    %39 = llvm.icmp "eq" %38, %13 : i64
    llvm.intr.assume %39 : i1
    %40 = llvm.getelementptr %36[%34] : (!llvm.ptr, i64) -> !llvm.ptr, f32
    %41 = llvm.load %40 : !llvm.ptr -> f32
    %42 = llvm.getelementptr %0[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.array<1024 x f32>
    %43 = llvm.ptrtoint %42 : !llvm.ptr to i64
    %44 = llvm.and %43, %3  : i64
    %45 = llvm.icmp "eq" %44, %13 : i64
    llvm.intr.assume %45 : i1
    %46 = llvm.getelementptr %42[%34] : (!llvm.ptr, i64) -> !llvm.ptr, f32
