...
8:                                                ; preds = %5
  ...
  call void @vector_scalar_mul_aie_scalar(ptr @in1_cons_buff_0, ptr @out_buff_0, ptr @in0_cons_buff_0, i32 1024)
  ...
  call void @llvm.assume(i1 %14)
  call void @vector_scalar_mul_aie_scalar(ptr @in1_cons_buff_1, ptr @out_buff_1, ptr @in0_cons_buff_0, i32 1024)
  call void @llvm.aie2.release(i32 50, i32 1)
  call void @llvm.aie2.release(i32 53, i32 1)
  %19 = add i64 %6, 2
  br label %5
...
24:                                               ; preds = %21
  ...
  call void @vector_scalar_mul_aie_scalar(ptr @in1_cons_buff_0, ptr @out_buff_0, ptr @in0_cons_buff_1, i32 1024)
  call void @llvm.aie2.release(i32 50, i32 1)
  call void @llvm.aie2.release(i32 53, i32 1)
  call void @llvm.aie2.acquire(i32 52, i32 -1)
  call void @llvm.aie2.acquire(i32 51, i32 -1)
  ...
  call void @llvm.assume(i1 %30)
  call void @vector_scalar_mul_aie_scalar(ptr @in1_cons_buff_1, ptr @out_buff_1, ptr @in0_cons_buff_1, i32 1024)
  call void @llvm.aie2.release(i32 50, i32 1)
  call void @llvm.aie2.release(i32 53, i32 1)
  %35 = add i64 %22, 2
  br label %21
