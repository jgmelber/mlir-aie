...
@in0_cons = external global [1024 x i32]
@in0 = external global [1024 x i32]
...
24:                                               ; preds = %21
  ...
  %32 = add i64 %22, 1
  call void @llvm.assume(i1 %26)
  %33 = getelementptr i32, ptr @in2to3_buff_1, i64 %32
...
43:                                               ; preds = %40
  %44 = and i64 ptrtoint (ptr @in2to3_buff_0 to i64), 31
  %45 = icmp eq i64 %44, 0
  call void @llvm.assume(i1 %45)
  %46 = getelementptr i32, ptr @in2to3_buff_0, i64 %41
  ...
  %51 = add i64 %41, 1
  call void @llvm.assume(i1 %45)
  %52 = getelementptr i32, ptr @in2to3_buff_0, i64 %51
...
64:                                               ; preds = %61
  %65 = and i64 ptrtoint (ptr @in2to3_buff_1 to i64), 31
  %66 = icmp eq i64 %65, 0
  call void @llvm.assume(i1 %66)
  %67 = getelementptr i32, ptr @in2to3_buff_1, i64 %62
...
77:                                               ; preds = %74
  %78 = and i64 ptrtoint (ptr @in2to3_buff_0 to i64), 31
  %79 = icmp eq i64 %78, 0
  call void @llvm.assume(i1 %79)
  %80 = getelementptr i32, ptr @in2to3_buff_0, i64 %75
  ...
  %85 = add i64 %75, 1
  call void @llvm.assume(i1 %79)
  %86 = getelementptr i32, ptr @in2to3_buff_0, i64 %85
...
96:                                               ; preds = %93
  %97 = and i64 ptrtoint (ptr @in2to3_buff_1 to i64), 31
  %98 = icmp eq i64 %97, 0
  call void @llvm.assume(i1 %98)
  %99 = getelementptr i32, ptr @in2to3_buff_1, i64 %94
  ...
  %104 = add i64 %94, 1
  call void @llvm.assume(i1 %98)
  %105 = getelementptr i32, ptr @in2to3_buff_1, i64 %104
...
118:                                              ; preds = %115
  %119 = and i64 ptrtoint (ptr @in2to3_buff_0 to i64), 31
  %120 = icmp eq i64 %119, 0
  call void @llvm.assume(i1 %120)
  %121 = getelementptr i32, ptr @in2to3_buff_0, i64 %116
...
131:                                              ; preds = %128
  %132 = and i64 ptrtoint (ptr @in2to3_buff_1 to i64), 31
  %133 = icmp eq i64 %132, 0
  call void @llvm.assume(i1 %133)
  %134 = getelementptr i32, ptr @in2to3_buff_1, i64 %129
  ...
  %139 = add i64 %129, 1
  call void @llvm.assume(i1 %133)
  %140 = getelementptr i32, ptr @in2to3_buff_1, i64 %139
...
150:                                              ; preds = %147
  %151 = and i64 ptrtoint (ptr @in2to3_buff_0 to i64), 31
  %152 = icmp eq i64 %151, 0
  call void @llvm.assume(i1 %152)
  %153 = getelementptr i32, ptr @in2to3_buff_0, i64 %148
  ...
  %158 = add i64 %148, 1
  call void @llvm.assume(i1 %152)
  %159 = getelementptr i32, ptr @in2to3_buff_0, i64 %158
...
8:                                                ; preds = %5
  ...
  call void @vector_scalar_mul_aie_scalar(ptr @in0_cons_buff_0, ptr @in0to1_buff_0, ptr @infactor_cons_buff_0, i32 1024)
  ...
  call void @llvm.assume(i1 %12)
  %17 = and i64 ptrtoint (ptr @in0_cons_buff_1 to i64), 31
  %18 = icmp eq i64 %17, 0
  call void @llvm.assume(i1 %18)
  call void @vector_scalar_mul_aie_scalar(ptr @in0_cons_buff_1, ptr @in0to1_buff_1, ptr @infactor_cons_buff_0, i32 1024)
  call void @llvm.aie2.release(i32 48, i32 1)
  call void @llvm.aie2.release(i32 53, i32 1)
  %19 = add i64 %6, 2
  br label %5
...
20:                                               ; preds = %5
  ...
  %23 = and i64 ptrtoint (ptr @infactor_cons_buff_0 to i64), 31
  %24 = icmp eq i64 %23, 0
...
30:                                               ; preds = %27
  ...
  %33 = and i64 ptrtoint (ptr @infactor_cons_buff_1 to i64), 31
  %34 = icmp eq i64 %33, 0
  call void @llvm.assume(i1 %34)
  %35 = and i64 ptrtoint (ptr @in0_cons_buff_1 to i64), 31
  %36 = icmp eq i64 %35, 0
  call void @llvm.assume(i1 %36)
  call void @vector_scalar_mul_aie_scalar(ptr @in0_cons_buff_1, ptr @in0to1_buff_1, ptr @infactor_cons_buff_1, i32 1024)
  call void @llvm.aie2.release(i32 48, i32 1)
  call void @llvm.aie2.release(i32 53, i32 1)
  call void @llvm.aie2.acquire(i32 52, i32 -1)
  call void @llvm.aie2.acquire(i32 49, i32 -1)
  ...
  call void @llvm.assume(i1 %34)
  call void @llvm.assume(i1 %26)
  call void @vector_scalar_mul_aie_scalar(ptr @in0_cons_buff_0, ptr @in0to1_buff_0, ptr @infactor_cons_buff_1, i32 1024)
  call void @llvm.aie2.release(i32 48, i32 1)
  call void @llvm.aie2.release(i32 53, i32 1)
  %37 = add i64 %28, 2
  br label %27
...
38:                                               ; preds = %27
  ...
  %41 = and i64 ptrtoint (ptr @infactor_cons_buff_1 to i64), 31
  %42 = icmp eq i64 %41, 0
  call void @llvm.assume(i1 %42)
...
50:                                               ; preds = %47
  ...
  %52 = icmp eq i64 %51, 0
  call void @llvm.assume(i1 %52)
  %53 = and i64 ptrtoint (ptr @infactor_cons_buff_0 to i64), 31
  %54 = icmp eq i64 %53, 0
  call void @llvm.assume(i1 %54)
  ...
  call void @llvm.assume(i1 %54)
  %59 = and i64 ptrtoint (ptr @in0_cons_buff_1 to i64), 31
  %60 = icmp eq i64 %59, 0
...
62:                                               ; preds = %47
  ...
  %65 = and i64 ptrtoint (ptr @infactor_cons_buff_0 to i64), 31
  %66 = icmp eq i64 %65, 0
  call void @llvm.assume(i1 %66)
