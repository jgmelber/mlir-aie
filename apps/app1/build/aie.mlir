module {
  aie.device(npu1_4col) {
    ...
    aie.objectfifo @in2to3(%tile_0_2, {%tile_0_3}, 2 : i32) : !aie.objectfifo<memref<1024xi32>>
    aie.objectfifo @out(%tile_0_3, {%tile_0_0}, 2 : i32) : !aie.objectfifo<memref<1024xi32>>
    %core_0_2 = aie.core(%tile_0_2) {
      ...
      scf.for %arg0 = %c0 to %c9223372036854775807 step %c1 {
        ...
        scf.for %arg1 = %c0_0 to %c4 step %c1_1 {
          %2 = aie.objectfifo.acquire @in2to3(Produce, 1) : !aie.objectfifosubview<memref<1024xi32>>
