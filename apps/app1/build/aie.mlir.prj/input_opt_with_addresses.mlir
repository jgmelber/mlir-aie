module attributes {llvm.target_triple = "aie2"} {
  llvm.mlir.global external @in_cons_buff_1() {addr_space = 0 : i32} : !llvm.array<1024 x f32>
  llvm.mlir.global external @in_cons_buff_0() {addr_space = 0 : i32} : !llvm.array<1024 x f32>
  llvm.mlir.global external @in_factor_cons_buff_1() {addr_space = 0 : i32} : !llvm.array<1 x f32>
  llvm.mlir.global external @in_factor_cons_buff_0() {addr_space = 0 : i32} : !llvm.array<1 x f32>
  ...
  llvm.mlir.global external @in_factor_cons() {addr_space = 0 : i32} : !llvm.array<1 x f32>
  llvm.mlir.global external @in_factor() {addr_space = 0 : i32} : !llvm.array<1 x f32>
  llvm.mlir.global external @in_cons() {addr_space = 0 : i32} : !llvm.array<1024 x f32>
  llvm.mlir.global external @in() {addr_space = 0 : i32} : !llvm.array<1024 x f32>
  ...
  llvm.func @core_0_2() {
    %0 = llvm.mlir.addressof @in_factor_cons_buff_1 : !llvm.ptr
    ...
    %4 = llvm.mlir.addressof @in_factor_cons_buff_0 : !llvm.ptr
