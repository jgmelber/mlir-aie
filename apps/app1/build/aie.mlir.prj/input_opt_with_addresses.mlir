module attributes {llvm.target_triple = "aie2"} {
  ...
  llvm.func @core_0_3() {
    %0 = llvm.mlir.addressof @in1to2_buff_1 : !llvm.ptr
    %1 = llvm.mlir.addressof @in0to1_buff_1 : !llvm.ptr
    %2 = llvm.mlir.addressof @in1to2_buff_0 : !llvm.ptr
    %3 = llvm.mlir.constant(31 : index) : i64
    %4 = llvm.mlir.addressof @in0to1_buff_0 : !llvm.ptr
    %5 = llvm.mlir.constant(49 : i32) : i32
  ...
  ^bb8:  // pred: ^bb7
    ...
    %48 = llvm.add %35, %15 : i64
    llvm.br ^bb7(%48 : i64)
  ^bb9:  // pred: ^bb7
    llvm.call @llvm.aie2.release(%6, %9) : (i32, i32) -> ()
    llvm.call @llvm.aie2.release(%5, %9) : (i32, i32) -> ()
    %49 = llvm.add %19, %13 : i64
    llvm.br ^bb2(%49 : i64)
  ^bb10:  // pred: ^bb2
    %50 = llvm.add %17, %15 : i64
    llvm.br ^bb1(%50 : i64)
  ^bb11:  // pred: ^bb1
    llvm.return
  }
  ...
  ^bb11:  // pred: ^bb10
    ...
    %79 = llvm.getelementptr %3[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.array<1024 x i32>
