...
const int in_factor_cons_buff_0_offset = 13312;
float mlir_aie_read_buffer_in_factor_cons_buff_0(aie_libxaie_ctx_t* ctx, int index) {
u32 value; auto rc = XAie_DataMemRdWord(&(ctx->DevInst), XAie_TileLoc(0,2), in_factor_cons_buff_0_offset + (index*4), &value);
  union caster { int32_t i; float f; };
  caster c; c.i = value;
  return c.f;
}
int mlir_aie_write_buffer_in_factor_cons_buff_0(aie_libxaie_ctx_t* ctx, int index, float value) {
  union caster { int32_t i; float f; };
  caster c; c.f = value;
  int32_t int_value = c.i;
AieRC rc =    XAie_DataMemWrWord(&(ctx->DevInst), XAie_TileLoc(0,2), in_factor_cons_buff_0_offset + (index*4), int_value);
return rc;
}
const int in_factor_cons_buff_1_offset = 13316;
float mlir_aie_read_buffer_in_factor_cons_buff_1(aie_libxaie_ctx_t* ctx, int index) {
u32 value; auto rc = XAie_DataMemRdWord(&(ctx->DevInst), XAie_TileLoc(0,2), in_factor_cons_buff_1_offset + (index*4), &value);
  union caster { int32_t i; float f; };
  caster c; c.i = value;
  return c.f;
}
int mlir_aie_write_buffer_in_factor_cons_buff_1(aie_libxaie_ctx_t* ctx, int index, float value) {
  union caster { int32_t i; float f; };
  caster c; c.f = value;
  int32_t int_value = c.i;
AieRC rc =    XAie_DataMemWrWord(&(ctx->DevInst), XAie_TileLoc(0,2), in_factor_cons_buff_1_offset + (index*4), int_value);
return rc;
}
const int in_cons_buff_0_offset = 9216;
float mlir_aie_read_buffer_in_cons_buff_0(aie_libxaie_ctx_t* ctx, int index) {
u32 value; auto rc = XAie_DataMemRdWord(&(ctx->DevInst), XAie_TileLoc(0,2), in_cons_buff_0_offset + (index*4), &value);
  union caster { int32_t i; float f; };
  caster c; c.i = value;
  return c.f;
}
int mlir_aie_write_buffer_in_cons_buff_0(aie_libxaie_ctx_t* ctx, int index, float value) {
  union caster { int32_t i; float f; };
  caster c; c.f = value;
  int32_t int_value = c.i;
...
float mlir_aie_read_buffer_in_cons_buff_1(aie_libxaie_ctx_t* ctx, int index) {
u32 value; auto rc = XAie_DataMemRdWord(&(ctx->DevInst), XAie_TileLoc(0,2), in_cons_buff_1_offset + (index*4), &value);
  union caster { int32_t i; float f; };
  caster c; c.i = value;
  return c.f;
}
int mlir_aie_write_buffer_in_cons_buff_1(aie_libxaie_ctx_t* ctx, int index, float value) {
  union caster { int32_t i; float f; };
  caster c; c.f = value;
  int32_t int_value = c.i;
...
int mlir_aie_acquire_in_factor_cons_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 2;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(0,2), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_in_factor_cons_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 2;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(0,2), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_in_factor_cons_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 3;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(0,2), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_in_factor_cons_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 3;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(0,2), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_in_factor_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 2;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(0,0), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_in_factor_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 2;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(0,0), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_in_factor_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 3;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(0,0), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_in_factor_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 3;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(0,0), XAie_LockInit(id,value), timeout);
}
