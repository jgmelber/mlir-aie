...
u32 value; auto rc = XAie_DataMemRdWord(&(ctx->DevInst), XAie_TileLoc(0,2), in2to3_buff_0_offset + (index*4), &value);
  return value;
}
int mlir_aie_write_buffer_in2to3_buff_0(aie_libxaie_ctx_t* ctx, int index, int32_t value) {
  int32_t int_value = value;
AieRC rc =    XAie_DataMemWrWord(&(ctx->DevInst), XAie_TileLoc(0,2), in2to3_buff_0_offset + (index*4), int_value);
return rc;
}
const int in2to3_buff_1_offset = 5120;
int32_t mlir_aie_read_buffer_in2to3_buff_1(aie_libxaie_ctx_t* ctx, int index) {
u32 value; auto rc = XAie_DataMemRdWord(&(ctx->DevInst), XAie_TileLoc(0,2), in2to3_buff_1_offset + (index*4), &value);
  return value;
}
int mlir_aie_write_buffer_in2to3_buff_1(aie_libxaie_ctx_t* ctx, int index, int32_t value) {
  int32_t int_value = value;
AieRC rc =    XAie_DataMemWrWord(&(ctx->DevInst), XAie_TileLoc(0,2), in2to3_buff_1_offset + (index*4), int_value);
return rc;
}
