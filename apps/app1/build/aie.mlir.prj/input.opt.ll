...
13:                                               ; preds = %0, %13
  ...
  tail call void @vector_scalar_mul_aie_scalar(ptr nonnull @in_cons_buff_0, ptr nonnull @out_buff_0, ptr nonnull @infactor_cons_buff_0, i32 1024)
  ...
  tail call void @vector_scalar_mul_aie_scalar(ptr nonnull @in_cons_buff_1, ptr nonnull @out_buff_1, ptr nonnull @infactor_cons_buff_0, i32 1024)
  tail call void @llvm.aie2.release(i32 48, i32 1)
  tail call void @llvm.aie2.release(i32 53, i32 1)
  tail call void @llvm.aie2.acquire(i32 52, i32 -1)
  tail call void @llvm.aie2.acquire(i32 49, i32 -1)
  ...
  tail call void @vector_scalar_mul_aie_scalar(ptr nonnull @in_cons_buff_0, ptr nonnull @out_buff_0, ptr nonnull @infactor_cons_buff_1, i32 1024)
  tail call void @llvm.aie2.release(i32 48, i32 1)
  tail call void @llvm.aie2.release(i32 53, i32 1)
  tail call void @llvm.aie2.acquire(i32 52, i32 -1)
  tail call void @llvm.aie2.acquire(i32 49, i32 -1)
  tail call void @vector_scalar_mul_aie_scalar(ptr nonnull @in_cons_buff_1, ptr nonnull @out_buff_1, ptr nonnull @infactor_cons_buff_1, i32 1024)
  tail call void @llvm.aie2.release(i32 48, i32 1)
  tail call void @llvm.aie2.release(i32 53, i32 1)
  tail call void @llvm.aie2.acquire(i32 52, i32 -1)
  tail call void @llvm.aie2.acquire(i32 49, i32 -1)
