...
8:                                                ; preds = %5
  ...
  %9 = and i64 ptrtoint (ptr @in2to3_buff_0 to i64), 31
  %10 = icmp eq i64 %9, 0
  ...
  call void @vector_scalar_mul_aie_scalar(ptr @in_cons_buff_0, ptr @in2to3_buff_0, ptr @infactor_cons_buff_0, i32 1024)
  call void @llvm.aie2.release(i32 48, i32 1)
  call void @llvm.aie2.release(i32 53, i32 1)
  call void @llvm.aie2.acquire(i32 52, i32 -1)
  call void @llvm.aie2.acquire(i32 49, i32 -1)
  %15 = and i64 ptrtoint (ptr @in2to3_buff_1 to i64), 31
  %16 = icmp eq i64 %15, 0
  ...
  call void @vector_scalar_mul_aie_scalar(ptr @in_cons_buff_1, ptr @in2to3_buff_1, ptr @infactor_cons_buff_0, i32 1024)
  call void @llvm.aie2.release(i32 48, i32 1)
  call void @llvm.aie2.release(i32 53, i32 1)
  %19 = add i64 %6, 2
  br label %5
...
24:                                               ; preds = %21
  call void @llvm.aie2.acquire(i32 52, i32 -1)
  call void @llvm.aie2.acquire(i32 49, i32 -1)
  %25 = and i64 ptrtoint (ptr @in2to3_buff_0 to i64), 31
  %26 = icmp eq i64 %25, 0
  call void @llvm.assume(i1 %26)
  ...
  %30 = icmp eq i64 %29, 0
  call void @llvm.assume(i1 %30)
  call void @vector_scalar_mul_aie_scalar(ptr @in_cons_buff_0, ptr @in2to3_buff_0, ptr @infactor_cons_buff_1, i32 1024)
  call void @llvm.aie2.release(i32 48, i32 1)
  call void @llvm.aie2.release(i32 53, i32 1)
  call void @llvm.aie2.acquire(i32 52, i32 -1)
  call void @llvm.aie2.acquire(i32 49, i32 -1)
  %31 = and i64 ptrtoint (ptr @in2to3_buff_1 to i64), 31
  %32 = icmp eq i64 %31, 0
  ...
  call void @vector_scalar_mul_aie_scalar(ptr @in_cons_buff_1, ptr @in2to3_buff_1, ptr @infactor_cons_buff_1, i32 1024)
  call void @llvm.aie2.release(i32 48, i32 1)
  call void @llvm.aie2.release(i32 53, i32 1)
  %35 = add i64 %22, 2
  br label %21
...
42:                                               ; preds = %39
  call void @llvm.aie2.acquire(i32 52, i32 -1)
  call void @llvm.aie2.acquire(i32 49, i32 -1)
  %43 = and i64 ptrtoint (ptr @in2to3_buff_0 to i64), 31
  %44 = icmp eq i64 %43, 0
  ...
  call void @llvm.aie2.acquire(i32 52, i32 -1)
  call void @llvm.aie2.acquire(i32 49, i32 -1)
  %49 = and i64 ptrtoint (ptr @in2to3_buff_1 to i64), 31
  %50 = icmp eq i64 %49, 0
