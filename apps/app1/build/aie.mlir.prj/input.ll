...
@in_factor_cons = external global [1 x float]
@in_factor = external global [1 x float]
@in_cons = external global [1024 x float]
@in = external global [1024 x float]
...
8:                                                ; preds = %5
  ...
  %11 = and i64 ptrtoint (ptr @in_factor_cons_buff_0 to i64), 31
  %12 = icmp eq i64 %11, 0
  call void @llvm.assume(i1 %12)
  %13 = and i64 ptrtoint (ptr @in_cons_buff_0 to i64), 31
  %14 = icmp eq i64 %13, 0
  call void @llvm.assume(i1 %14)
  call void @vector_scalar_mul_aie_scalar(ptr @in_cons_buff_0, ptr @out_buff_0, ptr @in_factor_cons_buff_0, i32 1024)
  ...
  call void @vector_scalar_mul_aie_scalar(ptr @in_cons_buff_1, ptr @out_buff_1, ptr @in_factor_cons_buff_0, i32 1024)
  call void @llvm.aie2.release(i32 48, i32 1)
  call void @llvm.aie2.release(i32 53, i32 1)
  %19 = add i64 %6, 2
  br label %5
...
24:                                               ; preds = %21
  ...
  %27 = and i64 ptrtoint (ptr @in_factor_cons_buff_1 to i64), 31
  %28 = icmp eq i64 %27, 0
  call void @llvm.assume(i1 %28)
  %29 = and i64 ptrtoint (ptr @in_cons_buff_0 to i64), 31
  %30 = icmp eq i64 %29, 0
  call void @llvm.assume(i1 %30)
  call void @vector_scalar_mul_aie_scalar(ptr @in_cons_buff_0, ptr @out_buff_0, ptr @in_factor_cons_buff_1, i32 1024)
  call void @llvm.aie2.release(i32 48, i32 1)
  call void @llvm.aie2.release(i32 53, i32 1)
  call void @llvm.aie2.acquire(i32 52, i32 -1)
  call void @llvm.aie2.acquire(i32 49, i32 -1)
  ...
  call void @vector_scalar_mul_aie_scalar(ptr @in_cons_buff_1, ptr @out_buff_1, ptr @in_factor_cons_buff_1, i32 1024)
  call void @llvm.aie2.release(i32 48, i32 1)
  call void @llvm.aie2.release(i32 53, i32 1)
  %35 = add i64 %22, 2
  br label %21
...
42:                                               ; preds = %39
  ...
  %45 = and i64 ptrtoint (ptr @in_factor_cons_buff_0 to i64), 31
  %46 = icmp eq i64 %45, 0
