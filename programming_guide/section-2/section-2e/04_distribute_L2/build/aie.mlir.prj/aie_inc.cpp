...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile02_bd0), /* addrA */ 0x400,  /* len */ 32));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile02_bd1), /* addrA */ 0x4000,  /* len */ 32));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile03_bd0), /* addrA */ 0x400,  /* len */ 32));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile03_bd1), /* addrA */ 0x4000,  /* len */ 32));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile04_bd0), /* addrA */ 0x400,  /* len */ 32));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile04_bd1), /* addrA */ 0x4000,  /* len */ 32));
...
__mlir_aie_try(XAie_DmaSetLock(&(dma_tile01_bd0), XAie_LockInit(64,-3),XAie_LockInit(65,3)));
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile01_bd0), /* addrA */ 0x80000,  /* len */ 96));
...
__mlir_aie_try(XAie_DmaSetLock(&(dma_tile01_bd1), XAie_LockInit(64,-3),XAie_LockInit(65,3)));
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile01_bd1), /* addrA */ 0x90000,  /* len */ 96));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile01_bd2), /* addrA */ 0x80000,  /* len */ 32));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile01_bd3), /* addrA */ 0x90000,  /* len */ 32));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile01_bd24), /* addrA */ 0x80020,  /* len */ 32));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile01_bd25), /* addrA */ 0x90020,  /* len */ 32));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile01_bd4), /* addrA */ 0x80040,  /* len */ 32));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile01_bd5), /* addrA */ 0x90040,  /* len */ 32));
...
const int in2_cons_buff_0_offset = 1024;
int32_t mlir_aie_read_buffer_in2_cons_buff_0(aie_libxaie_ctx_t* ctx, int index) {
u32 value; auto rc = XAie_DataMemRdWord(&(ctx->DevInst), XAie_TileLoc(0,4), in2_cons_buff_0_offset + (index*4), &value);
  return value;
}
int mlir_aie_write_buffer_in2_cons_buff_0(aie_libxaie_ctx_t* ctx, int index, int32_t value) {
  int32_t int_value = value;
AieRC rc =    XAie_DataMemWrWord(&(ctx->DevInst), XAie_TileLoc(0,4), in2_cons_buff_0_offset + (index*4), int_value);
return rc;
}
const int in2_cons_buff_1_offset = 16384;
int32_t mlir_aie_read_buffer_in2_cons_buff_1(aie_libxaie_ctx_t* ctx, int index) {
u32 value; auto rc = XAie_DataMemRdWord(&(ctx->DevInst), XAie_TileLoc(0,4), in2_cons_buff_1_offset + (index*4), &value);
  return value;
}
int mlir_aie_write_buffer_in2_cons_buff_1(aie_libxaie_ctx_t* ctx, int index, int32_t value) {
  int32_t int_value = value;
AieRC rc =    XAie_DataMemWrWord(&(ctx->DevInst), XAie_TileLoc(0,4), in2_cons_buff_1_offset + (index*4), int_value);
return rc;
}
const int in1_cons_buff_0_offset = 1024;
int32_t mlir_aie_read_buffer_in1_cons_buff_0(aie_libxaie_ctx_t* ctx, int index) {
u32 value; auto rc = XAie_DataMemRdWord(&(ctx->DevInst), XAie_TileLoc(0,3), in1_cons_buff_0_offset + (index*4), &value);
  return value;
}
int mlir_aie_write_buffer_in1_cons_buff_0(aie_libxaie_ctx_t* ctx, int index, int32_t value) {
  int32_t int_value = value;
AieRC rc =    XAie_DataMemWrWord(&(ctx->DevInst), XAie_TileLoc(0,3), in1_cons_buff_0_offset + (index*4), int_value);
return rc;
}
const int in1_cons_buff_1_offset = 16384;
int32_t mlir_aie_read_buffer_in1_cons_buff_1(aie_libxaie_ctx_t* ctx, int index) {
u32 value; auto rc = XAie_DataMemRdWord(&(ctx->DevInst), XAie_TileLoc(0,3), in1_cons_buff_1_offset + (index*4), &value);
  return value;
}
int mlir_aie_write_buffer_in1_cons_buff_1(aie_libxaie_ctx_t* ctx, int index, int32_t value) {
  int32_t int_value = value;
AieRC rc =    XAie_DataMemWrWord(&(ctx->DevInst), XAie_TileLoc(0,3), in1_cons_buff_1_offset + (index*4), int_value);
return rc;
}
...
const int in_cons_buff_1_offset = 65536;
